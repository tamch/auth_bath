...
@interface SFSafariViewController (SWIFT_EXTENSION(SAPFoundation))
@end
...
/// \param with The initial url which will be loaded in the web view. Can not change later.
///
- (void)presentWebViewWith:(NSURL * _Nonnull)url completionHandler:(void (^ _Nonnull)(SFSafariViewController * _Nullable, NSError * _Nullable))completionHandler;
...
@interface UIWebView (SWIFT_EXTENSION(SAPFoundation))
@end


@interface NSURLSession (SWIFT_EXTENSION(SAPFoundation))
@end


@interface WKWebView (SWIFT_EXTENSION(SAPFoundation))
@end
